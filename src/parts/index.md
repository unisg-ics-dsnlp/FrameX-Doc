...
FrameX-Doc is the documentation of the FrameX ecosystem and tooling. You are currently reading it. Its based on [mdBook](https://github.com/rust-lang/mdBook) and you can find the source-code on [GitHub FrameX-Doc](https://github.com/unisg-ics-dsnlp/FrameX-Doc). Feel free to create a PR or open a Issue if anything is missing or wrong.
